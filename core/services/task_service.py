...
def list_tasks(include_done: bool = True, only_done: bool = False) -> list[Task]:
...
def update_task(task_id: int, title: str, description: str, priority: int, due_date: date | None = None) -> Task:
